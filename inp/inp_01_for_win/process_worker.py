...
# 串口通讯
# 频率的决定者以硬件的串口通讯频率决定
def get_serial_info( whether, pre_whether, now_status, action, usb, bits ):
...
if __name__ == "__main__":
    ...
    p_serial = multiprocessing.Process( target=get_serial_info, args=(chr, pre_chr, status_chr, action_chr, usb_arg, bits_arg, ) )
